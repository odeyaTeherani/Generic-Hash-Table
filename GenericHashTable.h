...
typedef struct Table {
	Object** arr;
	int d, type, listLength, tableFirstLength;
}Table;
...
/**
* Auxiliary method - returns the hash value of the value accordingly, Uses methods: "strHashFun", "intHashFun".
*/
int placeInTable(Table* table, void* data);

/**
* Auxiliary method - Multiply the array and copy the values ​​accordingly.
*/
void MultiplyTable(Table* table);

/**
* Auxiliary method - returns how meny object in the list.
*/
